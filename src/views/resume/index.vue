            ...
            <li class="companyItem layui-timeline-item" :style="newObj.companyItem">
              ...
              <div class="layui-timeline-content layui-text">
                <div class="company_con">
                  ...
                  <p class="companyJobDesc">负责<b class="bold-font">数据可信生态、微信小程序、监控大屏</b>等多款产品的研发工作，任职期间<b
                      class="bold-font">连续两年获得公司年度奉献奖</b></p>
                </div>
          ...
          <div class="jl-jy-item">
            <div class="jingyan-item">
              ...
              <div class="jinyan_list">
                ...
                <div class="jingyan-content projectIncome">1、保利威直播：完成uniApp平台接入保利威SDK直播预览接口，实现电商直播间动效交互与实现；
                  <br/>2、IM即时通讯：接入腾讯云IM即时通讯，实现直播间聊天室的通讯功能。
                  ...
                  <br/>3、响应式官网的开发：基于Vue3+ts实现公司官网的项目搭建，数据对接，实现响应式适配问题；
                </div>
              </div>
            </div>
            ...
            <div class="jingyan-item">
              ...
              <div class="jinyan_list">
                ...
                <div class="jingyan-content projectIncome">
                  1、函数式编程：负责数据交易过程中产生的追溯链路图，利用函数式编程实现了Ant/G6的二次封装；<br/>
                  2、封装组件：封装表单生成组件CrateForm实现数据应用及追踪，方便用户调用接口对数据来源进行可信验证；<br/>
                  3、从始至终的跟进、开发和实现：负责数据可信、文件可信、可信监管等子系统的各个功能模块的开发与实现。
                </div>
              </div>
            </div>
